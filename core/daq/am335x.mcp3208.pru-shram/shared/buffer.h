...
#define QPMU_PRU_SAMPLE_RATE_HZ 1200U

#define QPMU_PRU_MAGIC 0x51504D55U /* "QPMU" */

#define QPMU_PRU_STATUS_BOOTING   1U
#define QPMU_PRU_STATUS_FILLING   2U
#define QPMU_PRU_STATUS_PUBLISHED 3U
