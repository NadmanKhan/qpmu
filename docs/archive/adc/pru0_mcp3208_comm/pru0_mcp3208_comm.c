...
#define MCP3208_TSUCS_CYC    8  //CS~ Fall to First Rising CLK edge (min 20ns)
#define MCP3208_THI_CYC      18  //Clock High Time (min 45ns)
#define MCP3208_TLO_CYC      18  //Clock Low Time (min 45ns)
#define MCP3208_TCSH_CYC     20  //CS~ Disable Time (min 50ns)
...
/*  0b1110, //Single ended, ch6
  0b1111, //Single ended, ch7 */
};
